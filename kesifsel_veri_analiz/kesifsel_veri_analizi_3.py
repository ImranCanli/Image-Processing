...
if len(track_df) != 0:
    ...
    print("Time passed: ", time_diff)
    print("Number of frames to track (gt):", len(gt))
    print("Number of frames tracked (track success):", success_track_frame_success)
    ...
    plt.xlabel("frame")
    plt.ylabel("Öklid mesafesi gt ve track arasindaki")
